...
//-------------------------------------------------------------------------------------------------------------------------------------------------
{
    avatars[user.objectId] = [JSQMessagesAvatarImageFactory avatarImageWithImage:[Global getProfileImageFromURL:user[PF_USER_PICTURE]] diameter:30.0];
...
//-------------------------------------------------------------------------------------------------------------------------------------------------
{
	...
	if ([self outgoing:messages[indexPath.item]])
	{
        //[cell setBackgroundColor:[UIColor colorWithRed:51.0f/255.0f green:255.0f/255.0f blue:51.0f/255.0f alpha:1]];
